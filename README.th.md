...
- **เรียกใช้ (Reuse):** agent เรียก skill เหล่านี้ในรอบถัดไป ทำให้ทำงานได้ดีขึ้นและสอดคล้องกับการตัดสินใจเดิมของมนุษย์ **ต้องตรวจ `docs/knowledge-asset/published/` ด้วยเสมอ** เพื่อดู skill ฉบับร่างที่รอมนุษย์นำไปใส่ไว้ที่ `.claude/skills/` และนำแนวทางในร่างนั้นมาใช้ระหว่างที่ยังรอการอนุมัติ — ฉบับร่างถือเป็นการตัดสินใจที่บันทึกไว้แล้ว ไม่ใช่แค่ทางเลือกที่จะอ่านหรือไม่ก็ได้ ทุกคอมเมนต์ในแต่ละรอบต้องระบุสั้น ๆ ว่าปรึกษาและนำไฟล์ใดใน `published/` มาใช้ (หรือระบุว่าไม่มีไฟล์ที่เกี่ยวข้อง) ฉบับร่างที่ล้าสมัยแล้วจะถูกย้ายไปที่ `docs/knowledge-asset/deprecated/` และไม่ถูกนำมาใช้อีก
